...
class NovaPoshtaApi2
{
    ...
    /**
     * Получатель для свойства формата.
    ...
    /**
     * Подготовьте данные перед их возвратом.
    ...
    /**
     * Сделайте запрос в NovaPoshta API.
    ...
    private function request($model, $method, $params = null)
    {
        ...
        $post = 'xml' == $this->format ? $this->array2xml($data) : $post = json_encode($data);
...
//             throw new Exception('Code Exception '.__FILE__.':'.__LINE__) ;
    ...
    /**
     * Получить города компании НоваПочта.
    ...
    /**
     * Получите склады в городах.
     * Get warehouses by city.
     *
     * @param string $cityRef ID of city
     * @param int $page Страница, максимум 500 записей на странице.
     *
     * @param int $limit
     * @return mixed
     * @throws Exception
     * @since 3.9
     */
    public function getWarehouses($cityRef, $page = 0 , $limit = 0  )
    {
